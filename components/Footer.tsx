                    ...
                    <div className="md:col-span-3 pt-8 mt-8 border-t border-zinc-800/50">
                        <div className="flex flex-col md:flex-row justify-between items-center gap-4">
                            ...
                            <div className="flex items-center space-x-4">
                                <a href="https://github.com" className="text-zinc-500 hover:text-green-400 transition-colors">
                                    <Github className="w-4 h-4" />
                                </a>
                                <a href="https://twitter.com" className="text-zinc-500 hover:text-green-400 transition-colors">
                                    <Twitter className="w-4 h-4" />
                                </a>
                                <a href="mailto:ananthkvmohanan@gmail.com" className="text-zinc-500 hover:text-green-400 transition-colors">
